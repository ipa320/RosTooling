...
public class ActionSpecItemProvider extends SpecBaseItemProvider {
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_ActionSpec_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(RosPackage.Literals.ACTION_SPEC__GOAL,
				RosFactory.eINSTANCE.createMessageDefinition()));

		newChildDescriptors.add(createChildParameter(RosPackage.Literals.ACTION_SPEC__RESULT,
				RosFactory.eINSTANCE.createMessageDefinition()));

		newChildDescriptors.add(createChildParameter(RosPackage.Literals.ACTION_SPEC__FEEDBACK,
				RosFactory.eINSTANCE.createMessageDefinition()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify = childFeature == RosPackage.Literals.ACTION_SPEC__GOAL
