...
public class ParameterAnyItemProvider extends ParameterValueItemProvider {
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ParameterAny_value_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ParameterAny_value_feature",
								"_UI_ParameterAny_type"),
						RosPackage.Literals.PARAMETER_ANY__VALUE, true, false, false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_ParameterAny_type")
