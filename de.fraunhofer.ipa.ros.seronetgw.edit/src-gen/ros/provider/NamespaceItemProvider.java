	...
	protected void addPartsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Namespace_parts_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Namespace_parts_feature",
								"_UI_Namespace_type"),
						RosPackage.Literals.NAMESPACE__PARTS, true, false, false,
