	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ParameterBoolean_value_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ParameterBoolean_value_feature",
								"_UI_ParameterBoolean_type"),
						RosPackage.Literals.PARAMETER_BOOLEAN__VALUE, true, false, false,
