	...
	protected void addMessagePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Subscriber_message_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Subscriber_message_feature",
								"_UI_Subscriber_type"),
						RosPackage.Literals.SUBSCRIBER__MESSAGE, true, false, true, null, null, null));
	}
