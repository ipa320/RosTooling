	...
	protected void addServicePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ServiceClient_service_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ServiceClient_service_feature",
								"_UI_ServiceClient_type"),
						RosPackage.Literals.SERVICE_CLIENT__SERVICE, true, false, true, null, null, null));
	}
