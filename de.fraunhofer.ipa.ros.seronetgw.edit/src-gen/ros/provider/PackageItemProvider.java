...
public class PackageItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						RosPackage.Literals.PACKAGE__NAME, true, false, false,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(RosPackage.Literals.PACKAGE__SPEC, RosFactory.eINSTANCE.createServiceSpec()));

		newChildDescriptors
				.add(createChildParameter(RosPackage.Literals.PACKAGE__SPEC, RosFactory.eINSTANCE.createTopicSpec()));

		newChildDescriptors
				.add(createChildParameter(RosPackage.Literals.PACKAGE__SPEC, RosFactory.eINSTANCE.createActionSpec()));

		newChildDescriptors.add(
				createChildParameter(RosPackage.Literals.PACKAGE__ARTIFACT, RosFactory.eINSTANCE.createArtifact()));
	}
