...
public class NodeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						RosPackage.Literals.NODE__NAME, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
						null, null));
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(RosPackage.Literals.NODE__SERVICESERVER,
				RosFactory.eINSTANCE.createServiceServer()));

		newChildDescriptors
				.add(createChildParameter(RosPackage.Literals.NODE__PUBLISHER, RosFactory.eINSTANCE.createPublisher()));

		newChildDescriptors.add(
				createChildParameter(RosPackage.Literals.NODE__SUBSCRIBER, RosFactory.eINSTANCE.createSubscriber()));

		newChildDescriptors.add(createChildParameter(RosPackage.Literals.NODE__SERVICECLIENT,
				RosFactory.eINSTANCE.createServiceClient()));

		newChildDescriptors.add(createChildParameter(RosPackage.Literals.NODE__ACTIONSERVER,
				RosFactory.eINSTANCE.createActionServer()));

		newChildDescriptors.add(createChildParameter(RosPackage.Literals.NODE__ACTIONCLIENT,
				RosFactory.eINSTANCE.createActionClient()));

		newChildDescriptors
				.add(createChildParameter(RosPackage.Literals.NODE__PARAMETER, RosFactory.eINSTANCE.createParameter()));
	}
