...
public class ExternalDependencyItemProvider extends DependencyItemProvider {
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ExternalDependency_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ExternalDependency_name_feature",
								"_UI_ExternalDependency_type"),
						RosPackage.Literals.EXTERNAL_DEPENDENCY__NAME, true, false, false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_ExternalDependency_type")
