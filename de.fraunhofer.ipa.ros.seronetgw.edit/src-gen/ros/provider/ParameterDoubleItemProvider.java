	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ParameterDouble_value_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ParameterDouble_value_feature",
								"_UI_ParameterDouble_type"),
						RosPackage.Literals.PARAMETER_DOUBLE__VALUE, true, false, false,
