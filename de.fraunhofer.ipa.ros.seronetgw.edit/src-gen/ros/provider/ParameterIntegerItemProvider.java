	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ParameterInteger_value_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ParameterInteger_value_feature",
								"_UI_ParameterInteger_type"),
						RosPackage.Literals.PARAMETER_INTEGER__VALUE, true, false, false,
