	...
	protected void addPackagePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_PackageDependency_package_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_PackageDependency_package_feature",
								"_UI_PackageDependency_type"),
						RosPackage.Literals.PACKAGE_DEPENDENCY__PACKAGE, true, false, true, null, null, null));
	}
