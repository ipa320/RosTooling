...
public class ServiceSpecItemProvider extends SpecBaseItemProvider {
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_ServiceSpec_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(RosPackage.Literals.SERVICE_SPEC__REQUEST,
				RosFactory.eINSTANCE.createMessageDefinition()));

		newChildDescriptors.add(createChildParameter(RosPackage.Literals.SERVICE_SPEC__RESPONSE,
				RosFactory.eINSTANCE.createMessageDefinition()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify = childFeature == RosPackage.Literals.SERVICE_SPEC__REQUEST
