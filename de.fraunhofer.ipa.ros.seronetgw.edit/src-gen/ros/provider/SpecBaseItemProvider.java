 ...
 * @generated
 */
public class SpecBaseItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_SpecBase_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_SpecBase_name_feature",
								"_UI_SpecBase_type"),
						RosPackage.Literals.SPEC_BASE__NAME, true, false, false,
	...
	protected void addFullnamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_SpecBase_fullname_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_SpecBase_fullname_feature",
								"_UI_SpecBase_type"),
						RosPackage.Literals.SPEC_BASE__FULLNAME, false, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_SpecBase_type")
