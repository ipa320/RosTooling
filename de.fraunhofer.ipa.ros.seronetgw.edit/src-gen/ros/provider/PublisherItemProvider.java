	...
	protected void addMessagePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Publisher_message_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Publisher_message_feature",
								"_UI_Publisher_type"),
						RosPackage.Literals.PUBLISHER__MESSAGE, true, false, true, null, null, null));
	}
