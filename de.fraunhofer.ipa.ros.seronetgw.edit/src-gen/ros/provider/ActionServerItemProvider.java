...
public class ActionServerItemProvider extends NamespacedElementItemProvider {
	...
	protected void addActionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ActionServer_action_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ActionServer_action_feature",
								"_UI_ActionServer_type"),
						RosPackage.Literals.ACTION_SERVER__ACTION, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_ActionServer_type")
