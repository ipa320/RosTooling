 ...
 * </p>
 * <ul>
 *   <li>{@link ros1.impl.ModelImpl#getName <em>Name</em>}</li>
 *   <li>{@link ros1.impl.ModelImpl#getSpec <em>Spec</em>}</li>
 *   <li>{@link ros1.impl.ModelImpl#getArtifact <em>Artifact</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModelImpl extends MinimalEObjectImpl.Container implements Model {
	...
	protected EClass eStaticClass() {
		return Ros1Package.Literals.MODEL;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ros1Package.MODEL__NAME, oldName, name));
	}
	...
	public EList<SpecBase> getSpec() {
		if (spec == null) {
			spec = new EObjectContainmentWithInverseEList<SpecBase>(SpecBase.class, this, Ros1Package.MODEL__SPEC, Ros1Package.SPEC_BASE__PACKAGE);
		}
		return spec;
	}
	...
	public EList<Artifact> getArtifact() {
		if (artifact == null) {
			artifact = new EObjectContainmentEList<Artifact>(Artifact.class, this, Ros1Package.MODEL__ARTIFACT);
		}
		return artifact;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case Ros1Package.MODEL__ARTIFACT:
