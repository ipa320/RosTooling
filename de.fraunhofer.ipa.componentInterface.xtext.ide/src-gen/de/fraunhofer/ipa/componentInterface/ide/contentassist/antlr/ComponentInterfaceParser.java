		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRosServiceServerAccess().getSrvserverAssignment_5_1(), "rule__RosServiceServer__SrvserverAssignment_5_1");
					...
					put(grammarAccess.getRosServiceClientAccess().getSrvclientAssignment_5_1(), "rule__RosServiceClient__SrvclientAssignment_5_1");
