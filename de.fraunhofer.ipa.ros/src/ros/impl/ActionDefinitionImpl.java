 ...
 * </p>
 * <ul>
 *   <li>{@link ros.impl.ActionDefinitionImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActionDefinitionImpl extends MinimalEObjectImpl.Container implements ActionDefinition {
	...
	protected EClass eStaticClass() {
		return RosPackage.Literals.ACTION_DEFINITION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RosPackage.ACTION_DEFINITION__NAME, oldName, name));
	}
