 ...
 * </p>
 * <ul>
 *   <li>{@link ros1.impl.PackageSetImpl#getPackage <em>Package</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PackageSetImpl extends MinimalEObjectImpl.Container implements PackageSet {
	 ...
	 * @ordered
	 */
	protected EList<ros1.Package> package_;
	...
	protected EClass eStaticClass() {
		return Ros1Package.Literals.PACKAGE_SET;
	}
	 ...
	 * @generated
	 */
	public EList<ros1.Package> getPackage() {
		if (package_ == null) {
			package_ = new EObjectContainmentEList<ros1.Package>(ros1.Package.class, this, Ros1Package.PACKAGE_SET__PACKAGE);
		}
		return package_;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case Ros1Package.PACKAGE_SET__PACKAGE:
				getPackage().clear();
				getPackage().addAll((Collection<? extends ros1.Package>)newValue);
				return;
		}
