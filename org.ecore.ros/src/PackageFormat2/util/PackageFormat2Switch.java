 ...
 * @generated
 */
public class PackageFormat2Switch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PackageFormat2Package.PERSON_WITH_EMAIL_TYPE: {
				PersonWithEmailType personWithEmailType = (PersonWithEmailType)theEObject;
				T result = casePersonWithEmailType(personWithEmailType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PackageFormat2Package.PERSON_WITH_OPTIONAL_EMAIL_TYPE: {
				PersonWithOptionalEmailType personWithOptionalEmailType = (PersonWithOptionalEmailType)theEObject;
				T result = casePersonWithOptionalEmailType(personWithOptionalEmailType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Person With Email Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Person With Email Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePersonWithEmailType(PersonWithEmailType object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Person With Optional Email Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Person With Optional Email Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePersonWithOptionalEmailType(PersonWithOptionalEmailType object) {
		return null;
	}
