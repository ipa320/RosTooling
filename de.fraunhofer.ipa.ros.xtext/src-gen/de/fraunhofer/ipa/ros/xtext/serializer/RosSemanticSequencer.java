 ...
 */
package de.fraunhofer.ipa.ros.xtext.serializer;
...
public class RosSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_ActionClient(ISerializationContext context, ActionClient semanticObject) {
		if (errorAcceptor != null) {
			...
			if (transientValues.isValueTransient(semanticObject, RosPackage.Literals.ACTION_CLIENT__ACTION) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, RosPackage.Literals.ACTION_CLIENT__ACTION));
			if (transientValues.isValueTransient(semanticObject, RosPackage.Literals.NAMESPACED_ELEMENT__NAMESPACE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, RosPackage.Literals.NAMESPACED_ELEMENT__NAMESPACE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getActionClientAccess().getNameEStringParserRuleCall_3_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getActionClientAccess().getActionActionSpecEStringParserRuleCall_5_0_1(), semanticObject.eGet(RosPackage.Literals.ACTION_CLIENT__ACTION, false));
		feeder.accept(grammarAccess.getActionClientAccess().getNamespaceNamespaceParserRuleCall_7_0(), semanticObject.getNamespace());
		feeder.finish();
	}
	...
	protected void sequence_ActionServer(ISerializationContext context, ActionServer semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, RosPackage.Literals.NAMESPACED_ELEMENT__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, RosPackage.Literals.NAMESPACED_ELEMENT__NAME));
			if (transientValues.isValueTransient(semanticObject, RosPackage.Literals.ACTION_SERVER__ACTION) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, RosPackage.Literals.ACTION_SERVER__ACTION));
			if (transientValues.isValueTransient(semanticObject, RosPackage.Literals.NAMESPACED_ELEMENT__NAMESPACE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, RosPackage.Literals.NAMESPACED_ELEMENT__NAMESPACE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getActionServerAccess().getNameEStringParserRuleCall_3_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getActionServerAccess().getActionActionSpecEStringParserRuleCall_5_0_1(), semanticObject.eGet(RosPackage.Literals.ACTION_SERVER__ACTION, false));
		feeder.accept(grammarAccess.getActionServerAccess().getNamespaceNamespaceParserRuleCall_7_0(), semanticObject.getNamespace());
		feeder.finish();
	}
	...
	protected void sequence_Artifact(ISerializationContext context, Artifact semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, RosPackage.Literals.ARTIFACT__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, RosPackage.Literals.ARTIFACT__NAME));
			if (transientValues.isValueTransient(semanticObject, RosPackage.Literals.ARTIFACT__NODE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, RosPackage.Literals.ARTIFACT__NODE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getArtifactAccess().getNameEStringParserRuleCall_1_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getArtifactAccess().getNodeNodeParserRuleCall_4_0(), semanticObject.getNode());
		feeder.finish();
	}
	...
	protected void sequence_Parameter(ISerializationContext context, ros.Parameter semanticObject) {
		if (errorAcceptor != null) {
			...
			if (transientValues.isValueTransient(semanticObject, RosPackage.Literals.NAMESPACED_ELEMENT__NAMESPACE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, RosPackage.Literals.NAMESPACED_ELEMENT__NAMESPACE));
			if (transientValues.isValueTransient(semanticObject, RosPackage.Literals.PARAMETER__TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, RosPackage.Literals.PARAMETER__TYPE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getParameterAccess().getNameEStringParserRuleCall_3_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getParameterAccess().getNamespaceNamespaceParserRuleCall_5_0(), semanticObject.getNamespace());
		feeder.accept(grammarAccess.getParameterAccess().getTypeParameterTypeParserRuleCall_7_0(), semanticObject.getType());
		feeder.finish();
	}
	...
	protected void sequence_Publisher(ISerializationContext context, Publisher semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getPublisherAccess().getNameEStringParserRuleCall_3_0(), semanticObject.getName());
		...
		feeder.accept(grammarAccess.getPublisherAccess().getNamespaceNamespaceParserRuleCall_7_0(), semanticObject.getNamespace());
		feeder.finish();
	}
	...
	protected void sequence_ServiceClient(ISerializationContext context, ServiceClient semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, RosPackage.Literals.NAMESPACED_ELEMENT__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, RosPackage.Literals.NAMESPACED_ELEMENT__NAME));
			if (transientValues.isValueTransient(semanticObject, RosPackage.Literals.SERVICE_CLIENT__SERVICE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, RosPackage.Literals.SERVICE_CLIENT__SERVICE));
			if (transientValues.isValueTransient(semanticObject, RosPackage.Literals.NAMESPACED_ELEMENT__NAMESPACE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, RosPackage.Literals.NAMESPACED_ELEMENT__NAMESPACE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getServiceClientAccess().getNameEStringParserRuleCall_3_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getServiceClientAccess().getServiceServiceSpecEStringParserRuleCall_5_0_1(), semanticObject.eGet(RosPackage.Literals.SERVICE_CLIENT__SERVICE, false));
		feeder.accept(grammarAccess.getServiceClientAccess().getNamespaceNamespaceParserRuleCall_7_0(), semanticObject.getNamespace());
		feeder.finish();
	}
	...
	protected void sequence_ServiceServer(ISerializationContext context, ServiceServer semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, RosPackage.Literals.NAMESPACED_ELEMENT__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, RosPackage.Literals.NAMESPACED_ELEMENT__NAME));
			if (transientValues.isValueTransient(semanticObject, RosPackage.Literals.SERVICE_SERVER__SERVICE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, RosPackage.Literals.SERVICE_SERVER__SERVICE));
			if (transientValues.isValueTransient(semanticObject, RosPackage.Literals.NAMESPACED_ELEMENT__NAMESPACE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, RosPackage.Literals.NAMESPACED_ELEMENT__NAMESPACE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getServiceServerAccess().getNameEStringParserRuleCall_3_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getServiceServerAccess().getServiceServiceSpecEStringParserRuleCall_5_0_1(), semanticObject.eGet(RosPackage.Literals.SERVICE_SERVER__SERVICE, false));
		feeder.accept(grammarAccess.getServiceServerAccess().getNamespaceNamespaceParserRuleCall_7_0(), semanticObject.getNamespace());
		feeder.finish();
	}
	...
	protected void sequence_Subscriber(ISerializationContext context, Subscriber semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getSubscriberAccess().getNameEStringParserRuleCall_3_0(), semanticObject.getName());
		...
		feeder.accept(grammarAccess.getSubscriberAccess().getNamespaceNamespaceParserRuleCall_7_0(), semanticObject.getNamespace());
		feeder.finish();
	}
