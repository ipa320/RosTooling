...
/**
 * This is the item provider adapter for a {@link ros1.Package} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PackageItemProvider 
	...
	protected void addSpecPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Package_spec_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Package_spec_feature", "_UI_Package_type"),
	...
	public String getText(Object object) {
		String label = ((ros1.Package)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ros1.Package.class)) {
