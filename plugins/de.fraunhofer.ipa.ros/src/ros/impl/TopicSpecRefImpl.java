 ...
 * </p>
 * <ul>
 *   <li>{@link ros.impl.TopicSpecRefImpl#getTopicSpec <em>Topic Spec</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TopicSpecRefImpl extends AbstractTypeImpl implements TopicSpecRef {
    ...
    protected EClass eStaticClass() {
        return RosPackage.Literals.TOPIC_SPEC_REF;
    }
        ...
        if (topicSpec != null && topicSpec.eIsProxy()) {
            ...
            if (topicSpec != oldTopicSpec) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, RosPackage.TOPIC_SPEC_REF__TOPIC_SPEC, oldTopicSpec, topicSpec));
            }
        }
        return topicSpec;
    }
    ...
    public void setTopicSpec(TopicSpec newTopicSpec) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RosPackage.TOPIC_SPEC_REF__TOPIC_SPEC, oldTopicSpec, topicSpec));
    }
