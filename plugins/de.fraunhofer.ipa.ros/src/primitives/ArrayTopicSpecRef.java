 ...
 * </p>
 * <ul>
 *   <li>{@link primitives.ArrayTopicSpecRef#getTopicSpec <em>Topic Spec</em>}</li>
 * </ul>
 *
 * @see primitives.PrimitivesPackage#getArrayTopicSpecRef()
 * @model
 * @generated
 */
public interface ArrayTopicSpecRef extends AbstractType {
	 ...
	 * @see primitives.PrimitivesPackage#getArrayTopicSpecRef_TopicSpec()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link primitives.ArrayTopicSpecRef#getTopicSpec <em>Topic Spec</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
