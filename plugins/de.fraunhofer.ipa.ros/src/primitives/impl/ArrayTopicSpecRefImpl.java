 ...
 * </p>
 * <ul>
 *   <li>{@link primitives.impl.ArrayTopicSpecRefImpl#getTopicSpec <em>Topic Spec</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArrayTopicSpecRefImpl extends AbstractTypeImpl implements ArrayTopicSpecRef {
	...
	protected EClass eStaticClass() {
		return PrimitivesPackage.Literals.ARRAY_TOPIC_SPEC_REF;
	}
		...
		if (topicSpec != null && topicSpec.eIsProxy()) {
			...
			if (topicSpec != oldTopicSpec) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PrimitivesPackage.ARRAY_TOPIC_SPEC_REF__TOPIC_SPEC, oldTopicSpec, topicSpec));
			}
		}
		return topicSpec;
	}
	...
	public void setTopicSpec(TopicSpec newTopicSpec) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PrimitivesPackage.ARRAY_TOPIC_SPEC_REF__TOPIC_SPEC, oldTopicSpec, topicSpec));
	}
