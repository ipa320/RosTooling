 ...
 * </p>
 * <ul>
 *   <li>{@link primitives.impl.MessageDefinitionImpl#getMessagePart <em>Message Part</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MessageDefinitionImpl extends MinimalEObjectImpl.Container implements MessageDefinition {
	...
	protected EClass eStaticClass() {
		return PrimitivesPackage.Literals.MESSAGE_DEFINITION;
	}
	...
	public EList<MessagePart> getMessagePart() {
		if (messagePart == null) {
			messagePart = new EObjectContainmentEList<MessagePart>(MessagePart.class, this, PrimitivesPackage.MESSAGE_DEFINITION__MESSAGE_PART);
		}
		return messagePart;
	}
