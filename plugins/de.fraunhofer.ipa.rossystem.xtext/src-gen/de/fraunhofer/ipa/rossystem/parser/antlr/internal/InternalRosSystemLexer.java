...
public class InternalRosSystemLexer extends Lexer {
    ...
    public final void mRULE_DECINT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRosSystem.g:3954:13: ( ( '0' | '1' .. '9' ( RULE_DIGIT )* | '-' '1' .. '9' ( RULE_DIGIT )* ) )
            // InternalRosSystem.g:3954:15: ( '0' | '1' .. '9' ( RULE_DIGIT )* | '-' '1' .. '9' ( RULE_DIGIT )* )
            {
            // InternalRosSystem.g:3954:15: ( '0' | '1' .. '9' ( RULE_DIGIT )* | '-' '1' .. '9' ( RULE_DIGIT )* )
            int alt11=3;
            switch ( input.LA(1) ) {
            ...
            switch (alt11) {
                ...
                case 2 :
                    ...
                    break;
                case 3 :
                    // InternalRosSystem.g:3954:41: '-' '1' .. '9' ( RULE_DIGIT )*
                    {
                    match('-'); 
                    matchRange('1','9'); 
