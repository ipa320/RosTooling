...
public class InternalRosSystemLexer extends Lexer {
    ...
    public final void mRULE_DIGIT() throws RecognitionException {
        try {
            // InternalRosSystem.g:4294:21: ( '0' .. '9' )
            // InternalRosSystem.g:4294:23: '0' .. '9'
            {
            matchRange('0','9'); 
    ...
    public final void mRULE_BINARY() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRosSystem.g:4296:13: ( ( '0b' | '0B' ) ( '0' | '1' )+ )
            // InternalRosSystem.g:4296:15: ( '0b' | '0B' ) ( '0' | '1' )+
            {
            // InternalRosSystem.g:4296:15: ( '0b' | '0B' )
            int alt1=2;
            ...
            switch (alt1) {
                case 1 :
                    // InternalRosSystem.g:4296:16: '0b'
                    {
                    match("0b"); 
                    ...
                    break;
                case 2 :
                    // InternalRosSystem.g:4296:21: '0B'
                    {
                    match("0B"); 
            ...
            // InternalRosSystem.g:4296:27: ( '0' | '1' )+
            int cnt2=0;
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_BOOLEAN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRosSystem.g:4298:14: ( ( 'true' | 'false' ) )
            // InternalRosSystem.g:4298:16: ( 'true' | 'false' )
            {
            // InternalRosSystem.g:4298:16: ( 'true' | 'false' )
            int alt3=2;
            ...
            switch (alt3) {
                case 1 :
                    // InternalRosSystem.g:4298:17: 'true'
                    {
                    match("true"); 
                    ...
                    break;
                case 2 :
                    // InternalRosSystem.g:4298:24: 'false'
                    {
                    match("false"); 
    ...
    public final void mRULE_DOUBLE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRosSystem.g:4300:13: ( RULE_DECINT ( '.' ( RULE_DIGIT )* | ( '.' ( RULE_DIGIT )* )? ( 'E' | 'e' ) ( '-' | '+' )? RULE_DECINT ) )
            // InternalRosSystem.g:4300:15: RULE_DECINT ( '.' ( RULE_DIGIT )* | ( '.' ( RULE_DIGIT )* )? ( 'E' | 'e' ) ( '-' | '+' )? RULE_DECINT )
            {
            mRULE_DECINT(); 
            // InternalRosSystem.g:4300:27: ( '.' ( RULE_DIGIT )* | ( '.' ( RULE_DIGIT )* )? ( 'E' | 'e' ) ( '-' | '+' )? RULE_DECINT )
            int alt8=2;
            alt8 = dfa8.predict(input);
            switch (alt8) {
                case 1 :
                    // InternalRosSystem.g:4300:28: '.' ( RULE_DIGIT )*
                    {
                    match('.'); 
                    // InternalRosSystem.g:4300:32: ( RULE_DIGIT )*
                    loop4:
                    do {
                        int alt4=2;
                    ...
                    break;
                case 2 :
                    // InternalRosSystem.g:4300:44: ( '.' ( RULE_DIGIT )* )? ( 'E' | 'e' ) ( '-' | '+' )? RULE_DECINT
                    {
                    // InternalRosSystem.g:4300:44: ( '.' ( RULE_DIGIT )* )?
                    int alt6=2;
                    ...
                    switch (alt6) {
                        case 1 :
                            // InternalRosSystem.g:4300:45: '.' ( RULE_DIGIT )*
                            {
                            match('.'); 
                            // InternalRosSystem.g:4300:49: ( RULE_DIGIT )*
                            loop5:
                            do {
                                int alt5=2;
    ...
    public final void mRULE_DECINT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRosSystem.g:4302:13: ( ( '0' | '1' .. '9' ( RULE_DIGIT )* | '-' '0' .. '9' ( RULE_DIGIT )* ) )
            // InternalRosSystem.g:4302:15: ( '0' | '1' .. '9' ( RULE_DIGIT )* | '-' '0' .. '9' ( RULE_DIGIT )* )
            {
            // InternalRosSystem.g:4302:15: ( '0' | '1' .. '9' ( RULE_DIGIT )* | '-' '0' .. '9' ( RULE_DIGIT )* )
            int alt11=3;
            switch ( input.LA(1) ) {
            ...
            switch (alt11) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // InternalRosSystem.g:4302:20: '1' .. '9' ( RULE_DIGIT )*
                    {
                    matchRange('1','9'); 
                    // InternalRosSystem.g:4302:29: ( RULE_DIGIT )*
                    loop9:
                    do {
                        int alt9=2;
                    ...
                    break;
                case 3 :
                    // InternalRosSystem.g:4302:41: '-' '0' .. '9' ( RULE_DIGIT )*
                    {
                    match('-'); 
                    matchRange('0','9'); 
                    // InternalRosSystem.g:4302:54: ( RULE_DIGIT )*
                    loop10:
                    do {
                        int alt10=2;
    ...
    public final void mRULE_DAY() throws RecognitionException {
        try {
            // InternalRosSystem.g:4304:19: ( ( '1' .. '9' | '1' .. '3' '0' .. '9' ) )
            // InternalRosSystem.g:4304:21: ( '1' .. '9' | '1' .. '3' '0' .. '9' )
            {
            // InternalRosSystem.g:4304:21: ( '1' .. '9' | '1' .. '3' '0' .. '9' )
            int alt12=2;
            ...
            switch (alt12) {
                case 1 :
                    // InternalRosSystem.g:4304:22: '1' .. '9'
                    {
                    matchRange('1','9'); 
                    ...
                    break;
                case 2 :
                    // InternalRosSystem.g:4304:31: '1' .. '3' '0' .. '9'
                    {
                    matchRange('1','3'); 
                    matchRange('0','9'); 
    ...
    public final void mRULE_MONTH() throws RecognitionException {
        try {
            // InternalRosSystem.g:4306:21: ( ( '1' .. '9' | '1' '0' .. '2' ) )
            // InternalRosSystem.g:4306:23: ( '1' .. '9' | '1' '0' .. '2' )
            {
            // InternalRosSystem.g:4306:23: ( '1' .. '9' | '1' '0' .. '2' )
            int alt13=2;
            ...
            switch (alt13) {
                case 1 :
                    // InternalRosSystem.g:4306:24: '1' .. '9'
                    {
                    matchRange('1','9'); 
                    ...
                    break;
                case 2 :
                    // InternalRosSystem.g:4306:33: '1' '0' .. '2'
                    {
                    match('1'); 
                    matchRange('0','2'); 
    ...
    public final void mRULE_YEAR() throws RecognitionException {
        try {
            // InternalRosSystem.g:4308:20: ( '0' .. '2' '0' .. '9' '0' .. '9' '0' .. '9' )
            // InternalRosSystem.g:4308:22: '0' .. '2' '0' .. '9' '0' .. '9' '0' .. '9'
            {
            matchRange('0','2'); 
            matchRange('0','9'); 
            matchRange('0','9'); 
    ...
    public final void mRULE_HOUR() throws RecognitionException {
        try {
            // InternalRosSystem.g:4310:20: ( ( '0' .. '1' '0' .. '9' | '2' '0' .. '3' ) )
            // InternalRosSystem.g:4310:22: ( '0' .. '1' '0' .. '9' | '2' '0' .. '3' )
            {
            // InternalRosSystem.g:4310:22: ( '0' .. '1' '0' .. '9' | '2' '0' .. '3' )
            int alt14=2;
            ...
            switch (alt14) {
                case 1 :
                    // InternalRosSystem.g:4310:23: '0' .. '1' '0' .. '9'
                    {
                    matchRange('0','1'); 
                    matchRange('0','9'); 
                    ...
                    break;
                case 2 :
                    // InternalRosSystem.g:4310:41: '2' '0' .. '3'
                    {
                    match('2'); 
                    matchRange('0','3'); 
    ...
    public final void mRULE_MIN_SEC() throws RecognitionException {
        try {
            // InternalRosSystem.g:4312:23: ( '0' .. '5' '0' .. '9' )
            // InternalRosSystem.g:4312:25: '0' .. '5' '0' .. '9'
            {
            matchRange('0','5'); 
            matchRange('0','9'); 
    ...
    public final void mRULE_DATE_TIME() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRosSystem.g:4314:16: ( RULE_YEAR '-' RULE_MONTH '-' RULE_DAY 'T' RULE_HOUR ':' RULE_MIN_SEC ':' RULE_MIN_SEC )
            // InternalRosSystem.g:4314:18: RULE_YEAR '-' RULE_MONTH '-' RULE_DAY 'T' RULE_HOUR ':' RULE_MIN_SEC ':' RULE_MIN_SEC
            {
            mRULE_YEAR(); 
            match('-'); 
            mRULE_MONTH(); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRosSystem.g:4316:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalRosSystem.g:4316:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalRosSystem.g:4316:11: ( '^' )?
            int alt15=2;
            ...
            // InternalRosSystem.g:4316:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop16:
            do {
                int alt16=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRosSystem.g:4318:10: ( ( '0' .. '9' )+ )
            // InternalRosSystem.g:4318:12: ( '0' .. '9' )+
            {
            // InternalRosSystem.g:4318:12: ( '0' .. '9' )+
            int cnt17=0;
            loop17:
            do {
                ...
                switch (alt17) {
            	case 1 :
            	    // InternalRosSystem.g:4318:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRosSystem.g:4320:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalRosSystem.g:4320:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalRosSystem.g:4320:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt20=2;
            ...
            switch (alt20) {
                case 1 :
                    // InternalRosSystem.g:4320:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalRosSystem.g:4320:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop18:
                    do {
                        int alt18=3;
                    ...
                    break;
                case 2 :
                    // InternalRosSystem.g:4320:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalRosSystem.g:4320:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop19:
                    do {
                        int alt19=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRosSystem.g:4322:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalRosSystem.g:4322:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalRosSystem.g:4322:24: ( options {greedy=false; } : . )*
            loop21:
            do {
                int alt21=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRosSystem.g:4324:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalRosSystem.g:4324:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalRosSystem.g:4324:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop22:
            do {
                int alt22=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRosSystem.g:4326:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalRosSystem.g:4326:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalRosSystem.g:4326:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt25=0;
            loop25:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRosSystem.g:4328:16: ( . )
            // InternalRosSystem.g:4328:18: .
            {
            matchAny(); 
    ...
    class DFA8 extends DFA {
        ...
        public String getDescription() {
            return "4300:27: ( '.' ( RULE_DIGIT )* | ( '.' ( RULE_DIGIT )* )? ( 'E' | 'e' ) ( '-' | '+' )? RULE_DECINT )";
        }
    }
