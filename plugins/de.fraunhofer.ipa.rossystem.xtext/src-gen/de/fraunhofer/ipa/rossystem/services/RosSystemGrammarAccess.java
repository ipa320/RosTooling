...
public class RosSystemGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class RosSystemElements extends AbstractParserRuleElementFinder {
		...
		//RosComponent+=ComponentInterface)*)? ')')? ('RosComponentStacks' '(' (ComponentStack+=ComponentStack (","
		//ComponentStack+=ComponentStack)*)? ')')? ('TopicConnections' '{' (TopicConnections+=TopicConnection (","
	...
	public class ComponentStackElements extends AbstractParserRuleElementFinder {
		...
		//'ComponentStack' '{' 'name' Name=EString ('RosComponents' '(' (RosComponent+=ComponentInterface (","
		//RosComponent+=ComponentInterface)*)? ')')? ('QualityAttributes' '(' (QualityAttribute+=QualityAttribute (","
	...
	public class QualityAttributeElements extends AbstractParserRuleElementFinder {
		...
		//QualityAttribute:
		//	'QualityAttribute'
		//	Name=EString ('type' Type=ParameterType)? ('value' Value=ParameterValue)?;
		@Override public ParserRule getRule() { return rule; }
		
		//'QualityAttribute' Name=EString ('type' Type=ParameterType)? ('value' Value=ParameterValue)?
		public Group getGroup() { return cGroup; }
