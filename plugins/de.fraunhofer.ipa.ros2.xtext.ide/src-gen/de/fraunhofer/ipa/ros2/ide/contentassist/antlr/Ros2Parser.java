...
public class Ros2Parser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, Ros2GrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getServiceSpecAccess().getRequestAssignment_4_2(), "rule__ServiceSpec__RequestAssignment_4_2");
			builder.put(grammarAccess.getServiceSpecAccess().getResponseAssignment_5_2(), "rule__ServiceSpec__ResponseAssignment_5_2");
			builder.put(grammarAccess.getActionSpecAccess().getNameAssignment_2(), "rule__ActionSpec__NameAssignment_2");
			builder.put(grammarAccess.getActionSpecAccess().getGoalAssignment_4_2(), "rule__ActionSpec__GoalAssignment_4_2");
			builder.put(grammarAccess.getActionSpecAccess().getResultAssignment_5_2(), "rule__ActionSpec__ResultAssignment_5_2");
			builder.put(grammarAccess.getActionSpecAccess().getFeedbackAssignment_6_2(), "rule__ActionSpec__FeedbackAssignment_6_2");
