...
/**
 * This is the item provider adapter for a {@link componentInterface.RosParameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RosParameterItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RosParameter_parameter_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RosParameter_parameter_feature", "_UI_RosParameter_type"),
				 ComponentInterfacePackage.Literals.ROS_PARAMETER__PARAMETER,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ComponentInterfacePackage.Literals.ROS_PARAMETER__NAME,
				 true,
				 false,
				 false,
	...
	protected void addNsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RosParameter_ns_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RosParameter_ns_feature", "_UI_RosParameter_type"),
				 ComponentInterfacePackage.Literals.ROS_PARAMETER__NS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ComponentInterfacePackage.Literals.ROS_PARAMETER__VALUE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ComponentInterfacePackage.Literals.ROS_PARAMETER__VALUE,
