...
public class RosGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ServiceSpecElements extends AbstractParserRuleElementFinder {
		...
		//ServiceSpec primitives::ServiceSpec:
		...
		//{primitives::ServiceSpec} 'ServiceSpec' name=EString '{' ('request' request=MessageDefinition)? ('response'
	...
	public class TopicSpecElements extends AbstractParserRuleElementFinder {
		...
		//TopicSpec primitives::TopicSpec:
		...
		//{primitives::TopicSpec} 'TopicSpec' name=(EString | 'Header') '{' ('message' message=MessageDefinition)? '}'
		public Group getGroup() { return cGroup; }
	...
	public class ActionSpecElements extends AbstractParserRuleElementFinder {
		...
		//{primitives::ActionSpec} 'ActionSpec' name=EString '{' ('goal' goal=MessageDefinition)? ('result'
		//result=MessageDefinition)? ('feedback' feedback=MessageDefinition)? '}'
		public Group getGroup() { return cGroup; }
	...
	public class MessageDefinitionElements extends AbstractParserRuleElementFinder {
		...
		//MessageDefinition primitives::MessageDefinition:
		//	{primitives::MessageDefinition}
		//	'{' (MessagePart+=MessagePart MessagePart+=MessagePart*)?
		//	'}';
		@Override public ParserRule getRule() { return rule; }
		
		//{primitives::MessageDefinition} '{' (MessagePart+=MessagePart MessagePart+=MessagePart*)? '}'
		public Group getGroup() { return cGroup; }
	...
	public class ServiceServerElements extends AbstractParserRuleElementFinder {
		...
		//	'{'
		//	'name' name=EString
		//	'service' service=[primitives::ServiceSpec|EString] ('namespace' namespace=Namespace)?
		//	'}';
		@Override public ParserRule getRule() { return rule; }
		
		//'ServiceServer' '{' 'name' name=EString 'service' service=[primitives::ServiceSpec|EString] ('namespace'
		//namespace=Namespace)? '}'
		public Group getGroup() { return cGroup; }
		...
		//service=[primitives::ServiceSpec|EString]
		public Assignment getServiceAssignment_5() { return cServiceAssignment_5; }
		
		//[primitives::ServiceSpec|EString]
	...
	public class PublisherElements extends AbstractParserRuleElementFinder {
		...
		//	'{'
		//	'name' name=EString
		//	'message' message=[primitives::TopicSpec|EString] ('namespace' namespace=Namespace)?
		//	'}';
		@Override public ParserRule getRule() { return rule; }
		
		//'Publisher' '{' 'name' name=EString 'message' message=[primitives::TopicSpec|EString] ('namespace' namespace=Namespace)?
		//'}'
		public Group getGroup() { return cGroup; }
	...
	public class SubscriberElements extends AbstractParserRuleElementFinder {
		...
		//'Subscriber' '{' 'name' name=EString 'message' message=[primitives::TopicSpec|EString] ('namespace'
		//namespace=Namespace)? '}'
		public Group getGroup() { return cGroup; }
	...
	public class ServiceClientElements extends AbstractParserRuleElementFinder {
		...
		//'ServiceClient' '{' 'name' name=EString 'service' service=[primitives::ServiceSpec|EString] ('namespace'
		//namespace=Namespace)? '}'
		public Group getGroup() { return cGroup; }
	...
	public class ActionServerElements extends AbstractParserRuleElementFinder {
		...
		//	'{'
		//	'name' name=EString
		//	'action' action=[primitives::ActionSpec|EString] ('namespace' namespace=Namespace)?
		//	'}';
		@Override public ParserRule getRule() { return rule; }
		
		//'ActionServer' '{' 'name' name=EString 'action' action=[primitives::ActionSpec|EString] ('namespace'
		//namespace=Namespace)? '}'
		public Group getGroup() { return cGroup; }
	...
	public class ActionClientElements extends AbstractParserRuleElementFinder {
		...
		//'ActionClient' '{' 'name' name=EString 'action' action=[primitives::ActionSpec|EString] ('namespace'
		//namespace=Namespace)? '}'
		public Group getGroup() { return cGroup; }
