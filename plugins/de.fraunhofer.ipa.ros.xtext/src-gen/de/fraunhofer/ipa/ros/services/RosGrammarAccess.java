...
public class RosGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class NodeElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cPublishersKeyword_4_0_0 = (Keyword)cGroup_4_0.eContents().get(0);
		private final Keyword cLeftCurlyBracketKeyword_4_0_1 = (Keyword)cGroup_4_0.eContents().get(1);
		private final Assignment cPublisherAssignment_4_0_2 = (Assignment)cGroup_4_0.eContents().get(2);
		private final RuleCall cPublisherPublisherParserRuleCall_4_0_2_0 = (RuleCall)cPublisherAssignment_4_0_2.eContents().get(0);
		...
		private final Assignment cPublisherAssignment_4_0_3_1 = (Assignment)cGroup_4_0_3.eContents().get(1);
		private final RuleCall cPublisherPublisherParserRuleCall_4_0_3_1_0 = (RuleCall)cPublisherAssignment_4_0_3_1.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_4_0_4 = (Keyword)cGroup_4_0.eContents().get(4);
		private final Group cGroup_4_1 = (Group)cUnorderedGroup_4.eContents().get(1);
		private final Keyword cSubscribersKeyword_4_1_0 = (Keyword)cGroup_4_1.eContents().get(0);
		private final Keyword cLeftCurlyBracketKeyword_4_1_1 = (Keyword)cGroup_4_1.eContents().get(1);
		private final Assignment cSubscriberAssignment_4_1_2 = (Assignment)cGroup_4_1.eContents().get(2);
		private final RuleCall cSubscriberSubscriberParserRuleCall_4_1_2_0 = (RuleCall)cSubscriberAssignment_4_1_2.eContents().get(0);
		...
		private final Assignment cSubscriberAssignment_4_1_3_1 = (Assignment)cGroup_4_1_3.eContents().get(1);
		private final RuleCall cSubscriberSubscriberParserRuleCall_4_1_3_1_0 = (RuleCall)cSubscriberAssignment_4_1_3_1.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_4_1_4 = (Keyword)cGroup_4_1.eContents().get(4);
		private final Group cGroup_4_2 = (Group)cUnorderedGroup_4.eContents().get(2);
		private final Keyword cServiceServersKeyword_4_2_0 = (Keyword)cGroup_4_2.eContents().get(0);
		private final Keyword cLeftCurlyBracketKeyword_4_2_1 = (Keyword)cGroup_4_2.eContents().get(1);
		private final Assignment cServiceserverAssignment_4_2_2 = (Assignment)cGroup_4_2.eContents().get(2);
		private final RuleCall cServiceserverServiceServerParserRuleCall_4_2_2_0 = (RuleCall)cServiceserverAssignment_4_2_2.eContents().get(0);
		...
		private final Assignment cServiceserverAssignment_4_2_3_1 = (Assignment)cGroup_4_2_3.eContents().get(1);
		private final RuleCall cServiceserverServiceServerParserRuleCall_4_2_3_1_0 = (RuleCall)cServiceserverAssignment_4_2_3_1.eContents().get(0);
		...
		private final Keyword cServiceClientsKeyword_4_3_0 = (Keyword)cGroup_4_3.eContents().get(0);
		...
		private final Keyword cActionServersKeyword_4_4_0 = (Keyword)cGroup_4_4.eContents().get(0);
		...
		private final Keyword cActionClientsKeyword_4_5_0 = (Keyword)cGroup_4_5.eContents().get(0);
		...
		private final Keyword cParametersKeyword_4_6_0 = (Keyword)cGroup_4_6.eContents().get(0);
		...
		//	'Node'
		//	'{'
		//	'name' name=RosNames (('Publishers' '{' publisher+=Publisher ("," publisher+=Publisher)* '}')? & ('Subscribers' '{'
		//	subscriber+=Subscriber ("," subscriber+=Subscriber)* '}')? & ('ServiceServers' '{' serviceserver+=ServiceServer (","
		//	serviceserver+=ServiceServer)* '}')? & ('ServiceClients' '{' serviceclient+=ServiceClient (","
		//	serviceclient+=ServiceClient)* '}')? & ('ActionServers' '{' actionserver+=ActionServer (","
		//	actionserver+=ActionServer)* '}')? & ('ActionClients' '{' actionclient+=ActionClient ("," actionclient+=ActionClient)*
		...
		//'Node' '{' 'name' name=RosNames (('Publishers' '{' publisher+=Publisher ("," publisher+=Publisher)* '}')? &
		//('Subscribers' '{' subscriber+=Subscriber ("," subscriber+=Subscriber)* '}')? & ('ServiceServers' '{'
		//serviceserver+=ServiceServer ("," serviceserver+=ServiceServer)* '}')? & ('ServiceClients' '{'
		//serviceclient+=ServiceClient ("," serviceclient+=ServiceClient)* '}')? & ('ActionServers' '{'
		//actionserver+=ActionServer ("," actionserver+=ActionServer)* '}')? & ('ActionClients' '{' actionclient+=ActionClient
		//("," actionclient+=ActionClient)* '}')? & ('Parameters' '{' parameter+=Parameter ("," parameter+=Parameter)* '}')?) //('ServiceServers' '{' serviceserver+=ServiceServer ( "," serviceserver+=ServiceServer)* '}')? &
		////(('Subscribers' '{' subscriber+=Subscriber '}')?  ( "," subscriber+=Subscriber)* '}')? &
		////('Publishers' '{' publisher+=Publisher '}')?)  ( "," publisher+=Publisher)* '}')? ) //&
		////('ServiceClients' '{' serviceclient+=ServiceClient ( "," serviceclient+=ServiceClient)* '}')? &
		////('ActionServers' '{' actionserver+=ActionServer ( "," actionserver+=ActionServer)* '}')? &
		...
		//("," subscriber+=Subscriber)* '}')? & ('ServiceServers' '{' serviceserver+=ServiceServer (","
		//serviceserver+=ServiceServer)* '}')? & ('ServiceClients' '{' serviceclient+=ServiceClient (","
		//serviceclient+=ServiceClient)* '}')? & ('ActionServers' '{' actionserver+=ActionServer (","
		//actionserver+=ActionServer)* '}')? & ('ActionClients' '{' actionclient+=ActionClient ("," actionclient+=ActionClient)*
		//'}')? & ('Parameters' '{' parameter+=Parameter ("," parameter+=Parameter)* '}')?
		...
		//'Publishers'
		public Keyword getPublishersKeyword_4_0_0() { return cPublishersKeyword_4_0_0; }
		
		//'{'
		public Keyword getLeftCurlyBracketKeyword_4_0_1() { return cLeftCurlyBracketKeyword_4_0_1; }
		
		//publisher+=Publisher
		public Assignment getPublisherAssignment_4_0_2() { return cPublisherAssignment_4_0_2; }
		
		//Publisher
		public RuleCall getPublisherPublisherParserRuleCall_4_0_2_0() { return cPublisherPublisherParserRuleCall_4_0_2_0; }
		...
		//publisher+=Publisher
		public Assignment getPublisherAssignment_4_0_3_1() { return cPublisherAssignment_4_0_3_1; }
		
		//Publisher
		public RuleCall getPublisherPublisherParserRuleCall_4_0_3_1_0() { return cPublisherPublisherParserRuleCall_4_0_3_1_0; }
		...
		//'Subscribers'
		public Keyword getSubscribersKeyword_4_1_0() { return cSubscribersKeyword_4_1_0; }
		
		//'{'
		public Keyword getLeftCurlyBracketKeyword_4_1_1() { return cLeftCurlyBracketKeyword_4_1_1; }
		
		//subscriber+=Subscriber
		public Assignment getSubscriberAssignment_4_1_2() { return cSubscriberAssignment_4_1_2; }
		
		//Subscriber
		public RuleCall getSubscriberSubscriberParserRuleCall_4_1_2_0() { return cSubscriberSubscriberParserRuleCall_4_1_2_0; }
		...
		//subscriber+=Subscriber
		public Assignment getSubscriberAssignment_4_1_3_1() { return cSubscriberAssignment_4_1_3_1; }
		
		//Subscriber
		public RuleCall getSubscriberSubscriberParserRuleCall_4_1_3_1_0() { return cSubscriberSubscriberParserRuleCall_4_1_3_1_0; }
		...
		//'ServiceServers'
		public Keyword getServiceServersKeyword_4_2_0() { return cServiceServersKeyword_4_2_0; }
		
		//'{'
		public Keyword getLeftCurlyBracketKeyword_4_2_1() { return cLeftCurlyBracketKeyword_4_2_1; }
		
		//serviceserver+=ServiceServer
		public Assignment getServiceserverAssignment_4_2_2() { return cServiceserverAssignment_4_2_2; }
		...
		//serviceserver+=ServiceServer
		public Assignment getServiceserverAssignment_4_2_3_1() { return cServiceserverAssignment_4_2_3_1; }
		
		//ServiceServer
		public RuleCall getServiceserverServiceServerParserRuleCall_4_2_3_1_0() { return cServiceserverServiceServerParserRuleCall_4_2_3_1_0; }
		...
		//'ServiceClients'
		public Keyword getServiceClientsKeyword_4_3_0() { return cServiceClientsKeyword_4_3_0; }
		...
		//'Parameters'
		public Keyword getParametersKeyword_4_6_0() { return cParametersKeyword_4_6_0; }
