...
public class RosSystemParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, RosSystemGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getRosSystemAccess().getGroup_3_2_2(), "rule__RosSystem__Group_3_2_2__0");
			builder.put(grammarAccess.getRosSystemAccess().getGroup_3_2_2_1(), "rule__RosSystem__Group_3_2_2_1__0");
			...
			builder.put(grammarAccess.getRosSystemAccess().getProcessAssignment_3_0_2(), "rule__RosSystem__ProcessAssignment_3_0_2");
			builder.put(grammarAccess.getRosSystemAccess().getRosnodeAssignment_3_1_2(), "rule__RosSystem__RosnodeAssignment_3_1_2");
			builder.put(grammarAccess.getRosSystemAccess().getParameterAssignment_3_2_2_0(), "rule__RosSystem__ParameterAssignment_3_2_2_0");
			builder.put(grammarAccess.getRosSystemAccess().getParameterAssignment_3_2_2_1_1(), "rule__RosSystem__ParameterAssignment_3_2_2_1_1");
