...
/**
 * This is the item provider adapter for a {@link rossystem.RosActionClient} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RosActionClientItemProvider extends NamedInterfaceItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_RosActionClient_From_feature", "_UI_RosActionClient_type"),
				 RossystemPackage.Literals.ROS_ACTION_CLIENT__FROM,
				 true,
				 false,
				 true,
				 null,
