 ...
 * </p>
 * <ul>
 *   <li>{@link rossystem.impl.RosSubscriberImpl#getFrom <em>From</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RosSubscriberImpl extends NamedInterfaceImpl implements RosSubscriber {
	...
	protected EClass eStaticClass() {
		return RossystemPackage.Literals.ROS_SUBSCRIBER;
	}
		...
		if (from != null && from.eIsProxy()) {
			...
			if (from != oldFrom) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RossystemPackage.ROS_SUBSCRIBER__FROM, oldFrom, from));
			}
		}
		return from;
	}
	...
	public void setFrom(Subscriber newFrom) {
		...
		from = newFrom;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RossystemPackage.ROS_SUBSCRIBER__FROM, oldFrom, from));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RossystemPackage.ROS_SUBSCRIBER__FROM:
