...
public class RossystemPackageImpl extends EPackageImpl implements RossystemPackage {
     ...
     */
    @Override
    public EReference getComponentRef_ComponentRef() {
    ...
    public void createPackageContents() {
        ...
        createEReference(componentRefEClass, COMPONENT_REF__COMPONENT_REF);
    }
    ...
    public void initializePackageContents() {
        ...
        componentRefEClass.getESuperTypes().add(this.getComponent());
        ...
        initEReference(getProcess_Nodes(), this.getComponent(), null, "nodes", null, 0, -1, system.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEReference(getComponentRef_ComponentRef(), this.getComponent(), null, "componentRef", null, 1, 1, ComponentRef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
