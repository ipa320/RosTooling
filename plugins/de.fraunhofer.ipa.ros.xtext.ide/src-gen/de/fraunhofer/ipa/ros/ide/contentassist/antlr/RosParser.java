...
public class RosParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, RosGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getNodeAccess().getPublisherAssignment_4_1_2(), "rule__Node__PublisherAssignment_4_1_2");
			builder.put(grammarAccess.getNodeAccess().getPublisherAssignment_4_1_3_1(), "rule__Node__PublisherAssignment_4_1_3_1");
			builder.put(grammarAccess.getNodeAccess().getSubscriberAssignment_4_2_2(), "rule__Node__SubscriberAssignment_4_2_2");
			builder.put(grammarAccess.getNodeAccess().getSubscriberAssignment_4_2_3_1(), "rule__Node__SubscriberAssignment_4_2_3_1");
