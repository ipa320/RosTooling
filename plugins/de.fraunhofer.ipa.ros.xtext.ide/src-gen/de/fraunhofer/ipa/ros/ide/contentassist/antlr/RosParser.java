...
public class RosParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, RosGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getNodeAccess().getGroup_4_0_2_1(), "rule__Node__Group_4_0_2_1__0");
			builder.put(grammarAccess.getNodeAccess().getGroup_4_1(), "rule__Node__Group_4_1__0");
			builder.put(grammarAccess.getNodeAccess().getGroup_4_1_2(), "rule__Node__Group_4_1_2__0");
			builder.put(grammarAccess.getNodeAccess().getGroup_4_1_2_1(), "rule__Node__Group_4_1_2_1__0");
			...
			builder.put(grammarAccess.getNodeAccess().getPublisherAssignment_4_0_2_0(), "rule__Node__PublisherAssignment_4_0_2_0");
			builder.put(grammarAccess.getNodeAccess().getPublisherAssignment_4_0_2_1_1(), "rule__Node__PublisherAssignment_4_0_2_1_1");
			builder.put(grammarAccess.getNodeAccess().getSubscriberAssignment_4_1_2_0(), "rule__Node__SubscriberAssignment_4_1_2_0");
			builder.put(grammarAccess.getNodeAccess().getSubscriberAssignment_4_1_2_1_1(), "rule__Node__SubscriberAssignment_4_1_2_1_1");
