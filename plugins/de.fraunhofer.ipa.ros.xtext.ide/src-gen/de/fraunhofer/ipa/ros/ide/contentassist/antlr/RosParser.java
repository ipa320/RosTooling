		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getParameterSequenceAccess().getGroup_1_2(), "rule__ParameterSequence__Group_1_2__0");
					...
					put(grammarAccess.getParameterSequenceAccess().getValueAssignment_1_1(), "rule__ParameterSequence__ValueAssignment_1_1");
					put(grammarAccess.getParameterSequenceAccess().getValueAssignment_1_2_1(), "rule__ParameterSequence__ValueAssignment_1_2_1");
					put(grammarAccess.getParameterAnyAccess().getValueAssignment_3_1(), "rule__ParameterAny__ValueAssignment_3_1");
					put(grammarAccess.getParameterStringAccess().getValueAssignment(), "rule__ParameterString__ValueAssignment");
					put(grammarAccess.getParameterBase64Access().getValueAssignment(), "rule__ParameterBase64__ValueAssignment");
					put(grammarAccess.getParameterIntegerAccess().getValueAssignment_3(), "rule__ParameterInteger__ValueAssignment_3");
					put(grammarAccess.getParameterDoubleAccess().getValueAssignment(), "rule__ParameterDouble__ValueAssignment");
					put(grammarAccess.getParameterBooleanAccess().getValueAssignment(), "rule__ParameterBoolean__ValueAssignment");
					...
					put(grammarAccess.getParameterDateAccess().getValueAssignment_0(), "rule__ParameterDate__ValueAssignment_0");
