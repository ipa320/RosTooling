...
public class ParameterImpl extends NamespacedElementImpl implements Parameter {
	...
	public NotificationChain basicSetType(ParameterType newType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RosPackage.PARAMETER__TYPE,
					oldType, newType);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newType != type) {
			...
			if (type != null)
				msgs = ((InternalEObject) type).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RosPackage.PARAMETER__TYPE, null, msgs);
			if (newType != null)
