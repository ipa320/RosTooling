	...
	public NotificationChain basicSetNamespace(Namespace newNamespace, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RosPackage.NAMESPACED_ELEMENT__NAMESPACE, oldNamespace, newNamespace);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newNamespace != namespace) {
			...
			if (namespace != null)
				msgs = ((InternalEObject) namespace).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RosPackage.NAMESPACED_ELEMENT__NAMESPACE, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RosPackage.NAMESPACED_ELEMENT__NAMESPACE,
