...
public class ServiceClientImpl extends NamespacedElementImpl implements ServiceClient {
		...
		if (service != null && service.eIsProxy()) {
			...
			if (service != oldService) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RosPackage.SERVICE_CLIENT__SERVICE,
							oldService, service));
			}
		}
		return service;
	...
	public void setService(ServiceSpec newService) {
		...
		service = newService;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RosPackage.SERVICE_CLIENT__SERVICE, oldService,
					service));
	}
