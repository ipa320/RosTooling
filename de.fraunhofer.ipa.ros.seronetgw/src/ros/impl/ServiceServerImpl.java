...
public class ServiceServerImpl extends NamespacedElementImpl implements ServiceServer {
		...
		if (service != null && service.eIsProxy()) {
			...
			if (service != oldService) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RosPackage.SERVICE_SERVER__SERVICE,
							oldService, service));
			}
		}
		return service;
	...
	public void setService(ServiceSpec newService) {
		...
		service = newService;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RosPackage.SERVICE_SERVER__SERVICE, oldService,
					service));
	}
