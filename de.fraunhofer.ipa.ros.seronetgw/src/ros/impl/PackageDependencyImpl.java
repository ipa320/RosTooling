...
public class PackageDependencyImpl extends DependencyImpl implements PackageDependency {
		...
		if (package_ != null && package_.eIsProxy()) {
			...
			if (package_ != oldPackage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RosPackage.PACKAGE_DEPENDENCY__PACKAGE,
							oldPackage, package_));
			}
		}
		return package_;
	...
	public void setPackage(ros.Package newPackage) {
		...
		package_ = newPackage;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RosPackage.PACKAGE_DEPENDENCY__PACKAGE, oldPackage,
					package_));
	}
