...
public class ParameterStructTypeMemberImpl extends MinimalEObjectImpl.Container implements ParameterStructTypeMember {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RosPackage.PARAMETER_STRUCT_TYPE_MEMBER__NAME,
					oldName, name));
	}
	...
	public NotificationChain basicSetType(ParameterType newType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RosPackage.PARAMETER_STRUCT_TYPE_MEMBER__TYPE, oldType, newType);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newType != type) {
			...
			if (type != null)
				msgs = ((InternalEObject) type).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RosPackage.PARAMETER_STRUCT_TYPE_MEMBER__TYPE, null, msgs);
			if (newType != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RosPackage.PARAMETER_STRUCT_TYPE_MEMBER__TYPE,
					newType, newType));
	}
	...
	public NotificationChain basicSetDefault(ParameterStruct newDefault, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RosPackage.PARAMETER_STRUCT_TYPE_MEMBER__DEFAULT, oldDefault, newDefault);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newDefault != default_) {
			...
			if (default_ != null)
				msgs = ((InternalEObject) default_).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RosPackage.PARAMETER_STRUCT_TYPE_MEMBER__DEFAULT, null, msgs);
			if (newDefault != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RosPackage.PARAMETER_STRUCT_TYPE_MEMBER__DEFAULT,
