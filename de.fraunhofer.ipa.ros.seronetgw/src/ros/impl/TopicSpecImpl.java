	...
	public NotificationChain basicSetMessage(MessageDefinition newMessage, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RosPackage.TOPIC_SPEC__MESSAGE, oldMessage, newMessage);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newMessage != message) {
			...
			if (message != null)
				msgs = ((InternalEObject) message).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RosPackage.TOPIC_SPEC__MESSAGE, null, msgs);
			if (newMessage != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RosPackage.TOPIC_SPEC__MESSAGE, newMessage,
					newMessage));
	}
