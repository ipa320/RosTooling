...
public class RosSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case RosPackage.SERVICE_SPEC: {
			...
			if (result == null)
				result = caseSpecBase(serviceSpec);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case RosPackage.SERVICE_SERVER: {
			...
			if (result == null)
				result = caseNamespacedElement(serviceServer);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case RosPackage.PUBLISHER: {
			...
			if (result == null)
				result = caseNamespacedElement(publisher);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case RosPackage.PACKAGE_DEPENDENCY: {
			...
			if (result == null)
				result = caseDependency(packageDependency);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case RosPackage.EXTERNAL_DEPENDENCY: {
			...
			if (result == null)
				result = caseDependency(externalDependency);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case RosPackage.CATKIN_PACKAGE: {
			...
			if (result == null)
				result = casePackage(catkinPackage);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case RosPackage.SUBSCRIBER: {
			...
			if (result == null)
				result = caseNamespacedElement(subscriber);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case RosPackage.SERVICE_CLIENT: {
			...
			if (result == null)
				result = caseNamespacedElement(serviceClient);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case RosPackage.ACTION_SPEC: {
			...
			if (result == null)
				result = caseSpecBase(actionSpec);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case RosPackage.ACTION_SERVER: {
			...
			if (result == null)
				result = caseNamespacedElement(actionServer);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case RosPackage.ACTION_CLIENT: {
			...
			if (result == null)
				result = caseNamespacedElement(actionClient);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case RosPackage.RELATIVE_NAMESPACE: {
			...
			if (result == null)
				result = caseNamespace(relativeNamespace);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case RosPackage.PRIVATE_NAMESPACE: {
			...
			if (result == null)
				result = caseRelativeNamespace(privateNamespace);
			if (result == null)
				result = caseNamespace(privateNamespace);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case RosPackage.PARAMETER_LIST_TYPE: {
			...
			if (result == null)
				result = caseParameterType(parameterListType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case RosPackage.PARAMETER_STRUCT_TYPE: {
			...
			if (result == null)
				result = caseParameterType(parameterStructType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case RosPackage.PARAMETER_INTEGER_TYPE: {
			...
			if (result == null)
				result = caseParameterType(parameterIntegerType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case RosPackage.PARAMETER_STRING_TYPE: {
			...
			if (result == null)
				result = caseParameterType(parameterStringType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case RosPackage.PARAMETER_DOUBLE_TYPE: {
			...
			if (result == null)
				result = caseParameterType(parameterDoubleType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case RosPackage.PARAMETER: {
			...
			if (result == null)
				result = caseNamespacedElement(parameter);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case RosPackage.PARAMETER_DATE_TYPE: {
			...
			if (result == null)
				result = caseParameterType(parameterDateType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case RosPackage.PARAMETER_BOOLEAN_TYPE: {
			...
			if (result == null)
				result = caseParameterType(parameterBooleanType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case RosPackage.PARAMETER_BASE64_TYPE: {
			...
			if (result == null)
				result = caseParameterType(parameterBase64Type);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case RosPackage.PARAMETER_ANY_TYPE: {
			...
			if (result == null)
				result = caseParameterType(parameterAnyType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case RosPackage.PARAMETER_ARRAY_TYPE: {
			...
			if (result == null)
				result = caseParameterType(parameterArrayType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case RosPackage.PARAMETER_ANY: {
			...
			if (result == null)
				result = caseParameterValue(parameterAny);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case RosPackage.PARAMETER_BASE64: {
			...
			if (result == null)
				result = caseParameterValue(parameterBase64);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case RosPackage.PARAMETER_SEQUENCE: {
			...
			if (result == null)
				result = caseParameterValue(parameterSequence);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case RosPackage.PARAMETER_STRUCT: {
			...
			if (result == null)
				result = caseParameterValue(parameterStruct);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case RosPackage.PARAMETER_DATE: {
			...
			if (result == null)
				result = caseParameterValue(parameterDate);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
