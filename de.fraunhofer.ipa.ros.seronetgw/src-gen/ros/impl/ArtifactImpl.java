...
public class ArtifactImpl extends MinimalEObjectImpl.Container implements Artifact {
	...
	public NotificationChain basicSetNode(Node newNode, NotificationChain msgs) {
		...
		node = newNode;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RosPackage.ARTIFACT__NODE,
					oldNode, newNode);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setNode(Node newNode) {
		if (newNode != node) {
			...
			if (node != null)
				msgs = ((InternalEObject) node).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RosPackage.ARTIFACT__NODE,
						null, msgs);
			if (newNode != null)
				msgs = ((InternalEObject) newNode).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RosPackage.ARTIFACT__NODE,
						null, msgs);
