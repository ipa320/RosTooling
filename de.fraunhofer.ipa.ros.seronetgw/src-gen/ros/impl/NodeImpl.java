...
public class NodeImpl extends MinimalEObjectImpl.Container implements Node {
	...
	public EList<ServiceServer> getServiceserver() {
		if (serviceserver == null) {
			serviceserver = new EObjectContainmentEList<ServiceServer>(ServiceServer.class, this,
					RosPackage.NODE__SERVICESERVER);
		}
	...
	public EList<ServiceClient> getServiceclient() {
		if (serviceclient == null) {
			serviceclient = new EObjectContainmentEList<ServiceClient>(ServiceClient.class, this,
					RosPackage.NODE__SERVICECLIENT);
		}
	...
	public EList<ActionServer> getActionserver() {
		if (actionserver == null) {
			actionserver = new EObjectContainmentEList<ActionServer>(ActionServer.class, this,
					RosPackage.NODE__ACTIONSERVER);
		}
		return actionserver;
	}
	...
	public EList<ActionClient> getActionclient() {
		if (actionclient == null) {
			actionclient = new EObjectContainmentEList<ActionClient>(ActionClient.class, this,
					RosPackage.NODE__ACTIONCLIENT);
		}
		return actionclient;
	}
