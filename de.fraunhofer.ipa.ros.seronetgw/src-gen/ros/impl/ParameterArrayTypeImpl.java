...
public class ParameterArrayTypeImpl extends ParameterTypeImpl implements ParameterArrayType {
	...
	public NotificationChain basicSetType(ParameterType newType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RosPackage.PARAMETER_ARRAY_TYPE__TYPE, oldType, newType);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newType != type) {
			...
			if (type != null)
				msgs = ((InternalEObject) type).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RosPackage.PARAMETER_ARRAY_TYPE__TYPE, null, msgs);
			if (newType != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RosPackage.PARAMETER_ARRAY_TYPE__TYPE, newType,
					newType));
	}
	...
	public NotificationChain basicSetDefault(ParameterSequence newDefault, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RosPackage.PARAMETER_ARRAY_TYPE__DEFAULT, oldDefault, newDefault);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newDefault != default_) {
			...
			if (default_ != null)
				msgs = ((InternalEObject) default_).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RosPackage.PARAMETER_ARRAY_TYPE__DEFAULT, null, msgs);
			if (newDefault != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RosPackage.PARAMETER_ARRAY_TYPE__DEFAULT, newDefault,
					newDefault));
	}
