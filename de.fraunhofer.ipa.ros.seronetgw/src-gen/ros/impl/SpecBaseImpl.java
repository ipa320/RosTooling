...
public abstract class SpecBaseImpl extends MinimalEObjectImpl.Container implements SpecBase {
	...
	public ros.Package getPackage() {
		if (eContainerFeatureID() != RosPackage.SPEC_BASE__PACKAGE)
			return null;
	...
	public void setPackage(ros.Package newPackage) {
		if (newPackage != eInternalContainer()
				|| (eContainerFeatureID() != RosPackage.SPEC_BASE__PACKAGE && newPackage != null)) {
			...
			if (newPackage != null)
				msgs = ((InternalEObject) newPackage).eInverseAdd(this, RosPackage.PACKAGE__SPEC, ros.Package.class,
						msgs);
			msgs = basicSetPackage(newPackage, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RosPackage.SPEC_BASE__PACKAGE, newPackage,
					newPackage));
	}
