...
public class RosFactoryImpl extends EFactoryImpl implements RosFactory {
	...
	public EObject create(EClass eClass) {
		...
		case RosPackage.RELATIVE_NAMESPACE:
			return createRelativeNamespace();
		case RosPackage.PRIVATE_NAMESPACE:
			return createPrivateNamespace();
		...
		case RosPackage.PARAMETER_SEQUENCE:
			return createParameterSequence();
		case RosPackage.PARAMETER_STRUCT:
			return createParameterStruct();
		case RosPackage.PARAMETER_STRUCT_MEMBER:
			return createParameterStructMember();
		case RosPackage.PARAMETER_DATE:
			return createParameterDate();
		default:
