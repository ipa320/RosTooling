	...
	public NotificationChain basicSetDefault(ParameterInteger newDefault, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RosPackage.PARAMETER_INTEGER_TYPE__DEFAULT, oldDefault, newDefault);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newDefault != default_) {
			...
			if (default_ != null)
				msgs = ((InternalEObject) default_).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RosPackage.PARAMETER_INTEGER_TYPE__DEFAULT, null, msgs);
			if (newDefault != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RosPackage.PARAMETER_INTEGER_TYPE__DEFAULT,
