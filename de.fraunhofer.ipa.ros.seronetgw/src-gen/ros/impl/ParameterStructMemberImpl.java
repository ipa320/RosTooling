...
public class ParameterStructMemberImpl extends MinimalEObjectImpl.Container implements ParameterStructMember {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RosPackage.PARAMETER_STRUCT_MEMBER__NAME, oldName,
					name));
	}
	...
	public NotificationChain basicSetValue(ParameterValue newValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RosPackage.PARAMETER_STRUCT_MEMBER__VALUE, oldValue, newValue);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject) value).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RosPackage.PARAMETER_STRUCT_MEMBER__VALUE, null, msgs);
			if (newValue != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RosPackage.PARAMETER_STRUCT_MEMBER__VALUE, newValue,
					newValue));
	}
