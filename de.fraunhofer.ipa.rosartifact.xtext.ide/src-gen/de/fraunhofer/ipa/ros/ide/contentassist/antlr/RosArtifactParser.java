...
import de.fraunhofer.ipa.ros.ide.contentassist.antlr.internal.InternalRosArtifactParser;
...
public class RosArtifactParser extends AbstractContentAssistParser {
	...
	@Override
	protected InternalRosArtifactParser createParser() {
		InternalRosArtifactParser result = new InternalRosArtifactParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getServiceServerAccess().getGroup_2(), "rule__ServiceServer__Group_2__0");
					...
					put(grammarAccess.getPublisherAccess().getGroup_2(), "rule__Publisher__Group_2__0");
					...
					put(grammarAccess.getSubscriberAccess().getGroup_2(), "rule__Subscriber__Group_2__0");
					...
					put(grammarAccess.getServiceClientAccess().getGroup_2(), "rule__ServiceClient__Group_2__0");
					...
					put(grammarAccess.getActionServerAccess().getGroup_2(), "rule__ActionServer__Group_2__0");
					put(grammarAccess.getActionServerAccess().getGroup_5(), "rule__ActionServer__Group_5__0");
					put(grammarAccess.getActionClientAccess().getGroup(), "rule__ActionClient__Group__0");
					put(grammarAccess.getActionClientAccess().getGroup_2(), "rule__ActionClient__Group_2__0");
					put(grammarAccess.getActionClientAccess().getGroup_5(), "rule__ActionClient__Group_5__0");
					...
					put(grammarAccess.getServiceServerAccess().getNameAssignment_2_1(), "rule__ServiceServer__NameAssignment_2_1");
					put(grammarAccess.getServiceServerAccess().getServiceAssignment_4(), "rule__ServiceServer__ServiceAssignment_4");
					put(grammarAccess.getServiceServerAccess().getNamespaceAssignment_5_1(), "rule__ServiceServer__NamespaceAssignment_5_1");
					put(grammarAccess.getPublisherAccess().getNameAssignment_2_1(), "rule__Publisher__NameAssignment_2_1");
					put(grammarAccess.getPublisherAccess().getMessageAssignment_4(), "rule__Publisher__MessageAssignment_4");
					put(grammarAccess.getPublisherAccess().getNamespaceAssignment_5_1(), "rule__Publisher__NamespaceAssignment_5_1");
					put(grammarAccess.getSubscriberAccess().getNameAssignment_2_1(), "rule__Subscriber__NameAssignment_2_1");
					put(grammarAccess.getSubscriberAccess().getMessageAssignment_4(), "rule__Subscriber__MessageAssignment_4");
					put(grammarAccess.getSubscriberAccess().getNamespaceAssignment_5_1(), "rule__Subscriber__NamespaceAssignment_5_1");
					put(grammarAccess.getServiceClientAccess().getNameAssignment_2_1(), "rule__ServiceClient__NameAssignment_2_1");
					put(grammarAccess.getServiceClientAccess().getServiceAssignment_4(), "rule__ServiceClient__ServiceAssignment_4");
					put(grammarAccess.getServiceClientAccess().getNamespaceAssignment_5_1(), "rule__ServiceClient__NamespaceAssignment_5_1");
					put(grammarAccess.getActionServerAccess().getNameAssignment_2_1(), "rule__ActionServer__NameAssignment_2_1");
					put(grammarAccess.getActionServerAccess().getActionAssignment_4(), "rule__ActionServer__ActionAssignment_4");
					put(grammarAccess.getActionServerAccess().getNamespaceAssignment_5_1(), "rule__ActionServer__NamespaceAssignment_5_1");
					put(grammarAccess.getActionClientAccess().getNameAssignment_2_1(), "rule__ActionClient__NameAssignment_2_1");
					put(grammarAccess.getActionClientAccess().getActionAssignment_4(), "rule__ActionClient__ActionAssignment_4");
					put(grammarAccess.getActionClientAccess().getNamespaceAssignment_5_1(), "rule__ActionClient__NamespaceAssignment_5_1");
					put(grammarAccess.getParameterAccess().getNameAssignment_2_1(), "rule__Parameter__NameAssignment_2_1");
					put(grammarAccess.getParameterAccess().getNamespaceAssignment_3_1(), "rule__Parameter__NamespaceAssignment_3_1");
