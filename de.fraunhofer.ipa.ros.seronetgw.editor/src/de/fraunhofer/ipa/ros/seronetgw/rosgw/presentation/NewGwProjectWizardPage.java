...
public class NewGwProjectWizardPage extends WizardPage {
	 ...
	 * @param pageName
	 */
	public NewGwProjectWizardPage(ISelection selection) {
		super("wizardPage");
		setTitle("New ROS-SeRoNet gateway project");
		setDescription("This wizard creates a new gateway project");
